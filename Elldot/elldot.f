     ...
     &                 DIAG1(M),DIAG2(M-2*NR),DIAG3(M-4*NR),
...
C**------------------------------------------------------------------***
C**   Setting the occupation numbers (NO B FIELD)                    ***
C**------------------------------------------------------------------***
C      WRITE(*,*) 'Please provide # of spin up electrons'
C      READ(*,*) OCU
      
C      WRITE(*,*) 'Please provide # of spin down electrons'
C      READ(*,*) OCD
C**------------------------------------------------------------------***
...
C         VD(I) = VEXT0(I) + VH0(I) + VXCD(I) - 0.5D0*G*MUBOHR*BB
         VU(I) = VEXT0(I) 
800      VD(I) = VEXT0(I)
...
C***********************************************************************
      ...
      OPEN(1,FILE='occup',STATUS='OLD',FORM='FORMATTED')
      OPEN(2,FILE='occdown',STATUS='OLD',FORM='FORMATTED')
