...
!      do bmag = 1, 9
  ...
  !      Bz(2) = 2.50d-2
        ...
        write(mwn,'(a,i1,a)') '4pt-B', bmag, '-BTot-n.txt'
        write(mwx,'(a,i1,a)') '4pt-B', bmag, '-BTot-mx.txt'
        write(mwy,'(a,i1,a)') '4pt-B', bmag, '-BTot-my.txt'
        write(mwz,'(a,i1,a)') '4pt-B', bmag, '-BTot-mz.txt'
...
!          do i=1,sites
!            vtest(sites + i) = blx(i)
!            vtest(sites*2 + i) = bly(i)
!            vtest(sites*3 + i) = blz(i)
!          end do
