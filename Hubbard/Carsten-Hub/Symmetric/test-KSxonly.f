     ...
     &        wmflg,wtflg,weflg,nd,revit,j,k
      INCLUDE 'dim.inc'
     ...
     &                 tplot(np+1),sing(nd),eback

      DOUBLE PRECISION etmats(101,np+2,3),etplot(np+2)
...
!          Bz(4) = 1.d-3
     ...
     &                                '-SlaterTCSym-mz.txt'
          elseif (bmag.eq.11) then
            write(mwn,'(a)') '4pt-B01-SlaterTCSym-n.txt'
            write(mwx,'(a)') '4pt-B01-SlaterTCSym-mx.txt'
            write(mwy,'(a)') '4pt-B01-SlaterTCSym-my.txt'
            write(mwz,'(a)') '4pt-B01-SlaterTCSym-mz.txt'
          end if
        ...
        if (wtflg.eq.1) then
          if (bmag.lt.10) then
            write(twx,'(a,i1,a)')
     &        '4pt-B', bmag, '-SlaterTCSym-tx.txt'
            write(twy,'(a,i1,a)')
     &        '4pt-B', bmag, '-SlaterTCSym-ty.txt'
            write(twz,'(a,i1,a)')
     &        '4pt-B', bmag, '-SlaterTCSym-tz.txt'
          elseif (bmag.eq.10) then
     ...
     &        '-SlaterTCSym-tz.txt'
          elseif (bmag.eq.11) then
            write(twx,'(a)') '4pt-B01-SlaterTCSym-tx.txt'
            write(twy,'(a)') '4pt-B01-SlaterTCSym-ty.txt'
            write(twz,'(a)') '4pt-B01-SlaterTCSym-tz.txt'
          end if
...
!          open(203,file = twz)
     ...
     &        '-SlaterTCSym-E.txt'
          elseif (bmag.eq.11) then
            write(twx,'(a)') '4pt-B01-SlaterTCSym-E.txt'
          end if
...
!        end if
        ...
        if (wtflg.eq.1) then
          if (bmag.lt.10) then
            write(twx,'(a,i1,a)')
!     &        '4pt-B', bmag, '-SlaterTCSym-tx.txt'
     &         '4pt-B', bmag, '-test-tx.txt'
            write(twy,'(a,i1,a)')
!     &        '4pt-B', bmag, '-SlaterTCSym-ty.txt'
     &         '4pt-B', bmag, '-test-ty.txt'
            write(twz,'(a,i1,a)')
!     &        '4pt-B', bmag, '-SlaterTCSym-tz.txt'
     &         '4pt-B', bmag, '-test-tz.txt'
          elseif (bmag.eq.10) then
            write(twx,'(a,i2,a)') '4pt-B', bmag,
!     &        '-SlaterTCSym-tx.txt'
     &         '-test-tx.txt'
...
!     &        '-SlaterTCSym-tz.txt'
     &         '-test-tz.txt'
          elseif (bmag.eq.11) then
            write(twx,'(a)') '4pt-B01-test-tx.txt'
            write(twy,'(a)') '4pt-B01-test-ty.txt'
            write(twz,'(a)') '4pt-B01-test-tz.txt'
          end if
        ...
        write(*,*) 'CCCCCCCCCCCCCCCCCCCCCCCCCCCCC'
        write(*,*) etmats(101,1,1)
        write(*,*) etmats(101,1,2)
        write(*,*) etmats(101,1,3)
        write(*,*) '@@@@@@@@@@@@@@@@@@@@@@@@@@@'
